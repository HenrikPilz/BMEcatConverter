...
from transformer.Separators import SeparatorTransformer, SeparatorNotDetectableException, \
...
class SeparatorTransformerTest( unittest.TestCase ):
    ...
    def testSeparatorAutoDetectExceptionAtSecondValue( self ):
        for firstInputValue, validationValue, secondInputValue in [
            ...
            self.assertEqual( validationValue, separatorTransformer.transform( firstInputValue ), "Aus '{0} sollte {1} werden.".format( firstInputValue, validationValue ) )
