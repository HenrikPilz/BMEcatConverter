...
class BMEcatImportHandler(handler.ContentHandler):
    ...
    def createProductDetails(self, attrs):
        self.raiseExceptionIfNone(self.__currentArticle,
                                  "Artikeldetails sollen erstellt werden. Aber es ist kein Artikel vorhanden")
        self.raiseExceptionIfNotNone(self.__currentArticle.details,
    ...
    def createOrderDetails(self, attrs):
        ...
        self.raiseExceptionIfNotNone(self.__currentArticle.orderDetails,
    ...
    def createPriceDetails(self, attrs):
        self.raiseExceptionIfNotNone(self.__currentPriceDetails,
    ...
    def createMime(self, attrs):
        self.raiseExceptionIfNotNone(self.__currentMime,
    ...
    def createPrice(self, attrs):
        self.raiseExceptionIfNotNone(self.__currentPrice,
    ...
    def createTreatmentClass(self, attrs):
        self.raiseExceptionIfNotNone(self.__currentTreatmentClass,
    ...
    def createFeatureSet(self, attrs=None):
        self.raiseExceptionIfNotNone(self.__currentFeature,
    ...
    def addFeatureSetReferenceSystem(self, attrs=None):
        self.raiseExceptionIfNone(self.__currentFeatureSet,
    ...
    def createReference(self, attrs=None):
        self.raiseExceptionIfNotNone(self.__currentReference,
    ...
    def addFeatureValue(self, attrs=None):
        self.raiseExceptionIfNotNoneOrNotEmpty(self.__currentFeature.variants,
                                               "Fehler im BMEcat: FeatureValue soll hinzugefuegt werden, es existieren aber schon FeatureVariants.")
        self.__currentElement.addValue(self.__currentContent)

    def addFeatureUnit(self, attrs=None):
        self.raiseExceptionIfNotNone(self.__currentFeature.unit,
                                     "Fehler im BMEcat: FeatureUnit soll gesetzt werden existiert aber schon.")
    ...
    def createFeatureVariantSet(self, attrs=None):
        self.raiseExceptionIfNotNoneOrNotEmpty(self.__currentFeature.values ,
                                               "Fehler im BMEcat: FeatureVariants sollen hinzugefuegt werden, es existieren aber schon FeatureValues.")
        self.raiseExceptionIfNotNone(self.__currentFeature.variants,
    ...
    def createFeatureVariant(self, attrs=None):
        self.raiseExceptionIfNotNone(self.__currentVariant,
    ...
    def addFeatureVariantProductIdSuffix(self, attrs=None):
        self.raiseExceptionIfNone(self.__currentVariant,
